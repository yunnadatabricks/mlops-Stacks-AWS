module "aws_create_sp" {
  ...
  service_principal_name       = "mlopsStackAWS20221108-cicd"
  project_directory_path       = "/mlopsStackAWS20221108"
  service_principal_group_name = "mlopsStackAWS20221108-service-principals"
}
...
provider "databricks" {
  alias = "staging_sp"
  host  = "https://dbc-df0101a0-8706.cloud.databricks.com"
